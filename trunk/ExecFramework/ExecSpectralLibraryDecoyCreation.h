#ifndef __ExecSpectralLibraryDecoyCreation_H__
#define __ExecSpectralLibraryDecoyCreation_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibraryDecoyCreation : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibraryDecoyCreation(void);
     ...
     */
    ExecSpectralLibraryDecoyCreation(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibraryDecoyCreation(void);
    //@}
