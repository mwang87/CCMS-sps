#ifndef __ExecProjection_H__
#define __ExecProjection_H__
...
namespace specnets
{
   ...
   */
  class ExecProjection : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecProjection(const ParameterList & inputParams);
  ...
  private:
    ...
    std::string m_projection_targets_file_name;
    
    std::vector<std::string> m_input_projection_target_sequences;
