#ifndef __ExecSpectralLibrarySLGFCreation_H__
#define __ExecSpectralLibrarySLGFCreation_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibrarySLGFCreation : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibrarySLGFCreation(void);
     ...
     */
    ExecSpectralLibrarySLGFCreation(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibrarySLGFCreation(void);
    //@}
  ...
  private:
    ...
    std::string m_output_decoy_mgf_file_name;
    std::string m_model_file_name;
    
    SpectralLibraryGFSearch m_library;
    SpectralLibraryGFSearch m_decoy_library;
    
    std::string m_output_SLGF_lib;
    
    std::string m_input_histogram_prefix;
    
    int m_SLGF_creation_start_idx;
    int m_SLGF_creation_end_idx;
  };
