#ifndef __ExecLibraryView_H__
#define __ExecLibraryView_H__
...
namespace specnets
{
   ...
   */
  class ExecLibraryView : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecLibraryView(const ParameterList & inputParams);
