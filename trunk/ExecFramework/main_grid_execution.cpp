...
int main(int argc, char ** argv)
{
  ...
  listOptions.push_back(CommandLineParser::Option("grid", "NODECOUNT", true));
  ...
  ParallelSgeExecution exec(moduleReal,
                                true,
                                false,
                                false);
  returnStatus = exec.invoke(ip.getValueInt("NODECOUNT", 1));
