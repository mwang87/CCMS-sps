#ifndef __ExecCreateSpectralLibraryMolecular_H__
#define __ExecCreateSpectralLibraryMolecular_H__
...
namespace specnets
{
   ...
   */
  class ExecCreateSpectralLibraryMolecular : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecCreateSpectralLibraryMolecular(void);
     ...
     */
    ExecCreateSpectralLibraryMolecular(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecCreateSpectralLibraryMolecular(void);
    //@}
  ...
  private:
    ...
    std::vector<string> input_psms_filenames;
    
    std::string results_dir;
    
    PeptideSpectrumMatchSet all_psms;
