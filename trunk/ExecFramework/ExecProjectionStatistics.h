 #ifndef __ExecProjectionStatistics_H__
#define __ExecProjectionStatistics_H__
...
namespace specnets
{
    ...
    /*! \brief Execution class for statistics for projections

   */
  class ExecProjectionStatistics : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecProjectionStatistics(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecProjectionStatistics(void);
    //@}
  ...
  private:
    void calculate_background(vector<vector<float> > average_spectra);  
    void calculate_substitutions(vector<vector<float> > average_spectra);
    void load_libs();
    ...
    std::vector<std::string> m_target_spectrum_file_names;
    std::vector<std::string> m_target_psm_file_names;
    std::vector<std::string> m_target_mgf_file_names;
    ...
    SpectralLibrary m_target_specs;
