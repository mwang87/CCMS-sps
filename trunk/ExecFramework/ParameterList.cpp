...
namespace specnets
{
  ...
  //---------------------------------------------------------------------------
  void ParameterList::getGroups(map<std::string, std::string> &groups, string &groupName)
  {
    for(map<std::string, std::string>::iterator it = parameters.begin(); it != parameters.end(); it++) {
