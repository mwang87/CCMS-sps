...
////////////////////////////////////////////////////////////////////////////////
// 
// This set of classes regenerates the various SPS report pages
// 
// 
////////////////////////////////////////////////////////////////////////////////
// Constants
...
var PAGE_FIELD_AAS_FILE           = "aas_file";
var PAGE_FIELD_CONTIG_REFS        = "contigRefs";
...
// number of elements per page (or table rows)
var PAGE_LENGTH = 10;
...
var TAG_CONDITIONAL_OR = '|'

var TAG_CONDITIONAL_EQ = '=';
var TAG_CONDITIONAL_IF = '?';
var TAG_CONDITIONAL_ELSE = ':';
...
var REPORT_HEADER_CONTIGS_0   = "Contig<br>Index";
...
var REPORT_HEADER_CONTIGS_5   = "Tool";

var REPORT_HEADER_CLUSTERS_0  = "Cluster<br>Index";
var REPORT_HEADER_CLUSTERS_1  = "Model";
...
var REPORT_HEADER_CLUSTERS_9  = "Tool";

var REPORT_HEADER_SPECTRA_0  = "Spectrum<br>Index";
var REPORT_HEADER_SPECTRA_1  = "Spectrum<br>Scan";
var REPORT_HEADER_SPECTRA_2  = "Model";
...
var REPORT_HEADER_SPECTRA_7  = "Cluster";
var REPORT_HEADER_SPECTRA_8  = "Mass (m)";
var REPORT_HEADER_SPECTRA_9  = "Charge (z)";
var REPORT_HEADER_SPECTRA_10 = "B (%)";
var REPORT_HEADER_SPECTRA_11 = "Y (%)";
var REPORT_HEADER_SPECTRA_12 = "BY Intensity (%)";
var REPORT_HEADER_SPECTRA_13 = "Tool";
...
var TABLE_CONTIGS_FIELD_SEQ_HOM_GRP   = 19;
var TABLE_CONTIGS_FIELD_SEQ_REF_GRP   = 20;
...
var TAG_TABLE_CONTIGS_FIELD_SEQ_REF_GRP   = makeTag(TABLE_CONTIGS_FIELD_SEQ_REF_GRP);
var TAG_TABLE_CONTIGS_FIELD_SEQ_HOM_GRP   = makeTag(TABLE_CONTIGS_FIELD_SEQ_HOM_GRP);
...
var INTERNAL_AAS_FNAME      = "aas_file";
...
var TAG_INTERNAL_AAS_FNAME  = makeTag(INTERNAL_AAS_FNAME);
...
var SPS_REPORTS       = "spsReports2.cgi";
...
var REPORT_SERVER_PAR_CONTIG_ID     = "--contig-id";
var REPORT_SERVER_PAR_CONTIG_STATUS = "--contig-status";
...
var CONTPLOT_VAL_SEQ_REFERENCE  = ASPAS + TAG_TABLE_CONTIGS_FIELD_SEQ_REF_GRP + ASPAS;
var CONTPLOT_VAL_SEQ_HOMOLOG    = ASPAS + TAG_TABLE_CONTIGS_FIELD_SEQ_HOM_GRP + ASPAS;
...
var CONTPLOT_VAL_AAS_FILE       = ASPAS + TAG_INTERNAL_AAS_FNAME + ASPAS;
...
// Model names & tags
var MODEL_NAME_PRM = "PRM";

// Specific conditional tags
var TAG_CLUSTER_MODEL_NAME_PREFIX = makeTag(TABLE_CLUSTER_FIELD_MODEL_NAME + TAG_CONDITIONAL_EQ + MODEL_NAME_PRM + TAG_CONDITIONAL_IF + TABLE_CLUSTER_FIELD_MODEL_NAME + TAG_CONDITIONAL_ELSE);

var TAG_SPECTRA_PEPTIDE_ALL  = makeTag(TABLE_SPECTRA_FIELD_SEQ_REFERENCE + TAG_CONDITIONAL_OR + TABLE_SPECTRA_FIELD_SEQ_HOMOLOG + TAG_CONDITIONAL_OR + TABLE_SPECTRA_FIELD_SEQ_DENOVO);

var TAG_CLUSTER_PEPTIDE_ALL  = makeTag(TABLE_CLUSTER_FIELD_REFERENCE + TAG_CONDITIONAL_OR + TABLE_CLUSTER_FIELD_HOMOLOG + TAG_CONDITIONAL_OR + TABLE_CLUSTER_FIELD_DENOVO);


// renderers' parameters values (specplot for cluster)
var SPECPLOT_VAL_CLUSTER_NOTITLE        = "";
var SPECPLOT_VAL_CLUSTER_TITLE          = "\"" + TAG_CLUSTER_MODEL_NAME_PREFIX + " Cluster Consensus Spectrum " + TAG_TABLE_CLUSTER_FIELD_ID + " (contig " + TAG_TABLE_CLUSTER_FIELD_CONTIG + ")\"";
...
var SPECPLOT_VAL_CLUSTER_AAS_FILE       = ASPAS + TAG_INTERNAL_AAS_FNAME + ASPAS;
...
var SPECPLOT_VAL_SPECTRA_AAS_FILE       = ASPAS + TAG_INTERNAL_AAS_FNAME + ASPAS;
...
var CONTPLOT_COND_SEQ_REFERENCE  = TAG_TABLE_CONTIGS_FIELD_SEQ_REF_GRP;
var CONTPLOT_COND_SEQ_HOMOLOG    = TAG_TABLE_CONTIGS_FIELD_SEQ_HOM_GRP;
...
var CONTPLOT_COND_AAS_FILE       = TAG_INTERNAL_AAS_FNAME;
...
var SPECPLOT_COND_CLUSTER_AAS_FILE       = TAG_INTERNAL_AAS_FNAME;
...
var SPECPLOT_COND_SPECTRA_AAS_FILE       = TAG_INTERNAL_AAS_FNAME;
...
function init()
{
  ...
  var obj = document.getElementById(PAGE_FIELD_AAS_FILE);
  if(obj)
    AAS_FILE = obj.value;

  var obj = document.getElementById(PAGE_FIELD_CONTIG_REFS);
  if(obj)
    CONTIG_REFS = obj.value;
...
function init2()
{
  // make sure 'enter' doesn't bo to the initial page
  idChecked = true;
...
function checkIds2()
{
  var idData = document.getElementById("password");
  CONTIG_DATA = idData.value;
  CONTIG_DATA = jQuery.base64.encode(CONTIG_DATA);
...
////////////////////////////////////////////////////////////////////////////////
function getContigData()
{
  var contigRequest;

  fnDone8 = function (oXML) {
    contigRequest = oXML.responseText;
    if(contigRequest == RESPONSE_OK) {
  ...
  var params = REPORT_SERVER_PAR_CONTIG_STATUS;
  params += '&' + REPORT_SERVER_PAR_TABLES_DIR    + '&' + TABLES_DIR;
  params += '&' + REPORT_SERVER_PAR_PROJECT_DIR   + '&' + PROJECT_DIR;
  params += '&' + REPORT_SERVER_PAR_CONTIG_ID     + '&"' + CONTIG_DATA + '"';
  AjaxGlobal(thePage, "GET", params, fnDone8, true);
}
////////////////////////////////////////////////////////////////////////////////
function getStatus()
{
  ...
  fnDone7 = function (oXML) {
    ...
    setTimeout(function() {getStatus();}, 60000);
  };
...
ImageCache.prototype.loadImage = function(renderer, params, theTag, target, force, sync, sequence)
{
  ...
  fnDone = function (oXML) {
    ...
    if(obj2) {
      if(target == "href")
        obj2.href = "data:image/png;base64," + res;
      else
        obj2.src = "data:image/png;base64," + res;
    }
    ...
    if(USE_IMAGE_CACHE && oXML.responseText.length)
      if(index == -1)
        This.add(aux);
      else
...
ReportTables.prototype.updateContig = function(fieldId, textId, img, ctrl, target, row, col)
{
  ...
  if(!checkSequence(str)) {
    alert("Please check the sequence.");
    return;
  }
...
////////////////////////////////////////////////////////////////////////////////
// isAA()
// Checks of a character is an amino acid
////////////////////////////////////////////////////////////////////////////////
function isAA(aa)
{
  var n = aa.toUpperCase();
  switch(n) {
  case 'A':
  case 'C':
  case 'D':
...
{
  var nPar = 0, nRect = 0;
  var nCharsInMass = 0, nCharsInSeq = 0, nChars = 0;
  var hasComma = 1;
  ...
  for(var i = 0 ; i < sequence.length ; i++) {
    ...
    case ')':
      if(nPar != 1 || nRect > 0)
        return false;
      if(hasComma == 1 && (nCharsInMass == 0 || nCharsInSeq != 0) )
        return false;
      if(hasComma == 0 && (nCharsInMass != 0 || nCharsInSeq == 0) )
        return false;
      nPar--;
      break;
...
function table()
{
  ...
  // the columns pagination may use for labels
  this.paginationColumns = [];
...
function tableProtein()
{
  ...
  this.sortColumn = TABLE_PROTEIN_ID;
}
...
function tableProteinCoverage()
{
  ...
  this.sortColumn = TABLE_COVERAGE_ID;
}
////////////////////////////////////////////////////////////////////////////////
...
function tableContig()
{
  ...
  // pagination columns
  this.paginationColumns.push(TABLE_CONTIGS_FIELD_ID);
  this.sortColumn = TABLE_CONTIGS_FIELD_ID;
}
////////////////////////////////////////////////////////////////////////////////
...
{
  var aux = "javascript:"
  aux += "TablesAll.updateContig(\"" + inputID + "\", \"" + suffix + "\", \"" + IMAGE_ICON_ID_PREFIX + suffix + "\", \"" + IMAGE_ICON_CTRL_ID_PREFIX + suffix + "\", \"src\", " + TAG_TABLE_CONTIGS_FIELD_ID + ", " + TABLE_CONTIGS_FIELD_SEQ_USER + ");";
  return aux;
}
////////////////////////////////////////////////////////////////////////////////
tableContig.prototype.defineView = function()
{
  ...
  auxI.iconParams.push( new ReportParamsOption(CONTPLOT_PAR_AAS_FILE,       CONTPLOT_VAL_AAS_FILE,      CONTPLOT_COND_AAS_FILE        ) );
...
function tableCluster()
{
  ...
  // pagination columns
  this.paginationColumns.push(TABLE_CLUSTER_FIELD_ID);
  this.sortColumn = TABLE_CLUSTER_FIELD_ID;
}
////////////////////////////////////////////////////////////////////////////////
...
tableCluster.prototype.buildUpdateCall = function(inputID, suffix, icon)
{
  ...
  if(typeof(icon) != 'undefined' && icon) {
    aux += "if(";
    aux += "TablesAll.updateCluster(\"" + inputID + "\", \"" + suffix + "\", \"" + IMAGE_LARGE_ID_PREFIX + suffix + "\", \"" + IMAGE_LARGE_CTRL_ID_PREFIX + suffix + "\", \"href\", " + TAG_TABLE_CLUSTER_FIELD_ID + "," + TABLE_CLUSTER_FIELD_USER + ", false)";
    aux += ") "
    aux += "triggerClick(\"" + IMAGE_LARGE_ID_PREFIX + suffix + "\", false);";
  } else {
    aux += "TablesAll.updateCluster(\"" + inputID + "\", null, \"" + IMAGE_ICON_ID_PREFIX + suffix + "\", \"" + IMAGE_ICON_CTRL_ID_PREFIX + suffix + "\", \"src\", " + TAG_TABLE_CLUSTER_FIELD_ID + "," + TABLE_CLUSTER_FIELD_USER + ", true);";
  }
...
// colTypes[6] . (CTstring) BY intensity %
  ...
  auxI.iconParams.push( new ReportParamsOption(SPECPLOT_PAR_AAS_FILE,   SPECPLOT_VAL_CLUSTER_AAS_FILE,    SPECPLOT_COND_CLUSTER_AAS_FILE    ) );
  ...
  auxI.params.push( new ReportParamsOption(SPECPLOT_PAR_AAS_FILE,   SPECPLOT_VAL_CLUSTER_AAS_FILE,    SPECPLOT_COND_CLUSTER_AAS_FILE    ) );
...
function tableInputSpectra()
{
  ...
  // pagination columns
  this.paginationColumns.push(TABLE_SPECTRA_FIELD_IDX);
  this.paginationColumns.push(TABLE_SPECTRA_FIELD_SCAN);
  this.sortColumn = TABLE_SPECTRA_FIELD_IDX;
}
////////////////////////////////////////////////////////////////////////////////
...
tableInputSpectra.prototype.buildUpdateCall = function(inputID, suffix)
{
  var aux = "javascript:";
  aux += "if(";
  aux += "TablesAll.updateSpectra(\"" + inputID + "\", \"" + suffix + "\", \"" + IMAGE_LARGE_ID_PREFIX + suffix + "\", \"" + IMAGE_LARGE_CTRL_ID_PREFIX + suffix + "\", \"href\", " + TAG_TABLE_SPECTRA_FIELD_ID + ", " + TABLE_SPECTRA_FIELD_SEQ_USER + ", false)";
  aux += ") ";
...
tableInputSpectra.prototype.defineView = function()
{
  ...
  auxI.iconParams.push( new ReportParamsOption(SPECPLOT_PAR_AAS_FILE, SPECPLOT_VAL_SPECTRA_AAS_FILE,    SPECPLOT_COND_SPECTRA_AAS_FILE    ) );
  ...
  auxI.params.push( new ReportParamsOption(SPECPLOT_PAR_AAS_FILE, SPECPLOT_VAL_SPECTRA_AAS_FILE,    SPECPLOT_COND_SPECTRA_AAS_FILE    ) );
  ...
  auxS.sortDataCol  = TABLE_SPECTRA_FIELD_CLUSTER;
  auxS.onClick      = "javascript:TablesAll.loadPage(" + PAGE_CLUSTER + "," + TAG_TABLE_SPECTRA_FIELD_CLUSTER + ");";
  auxS.link         = '#';
  auxS.text         = TAG_TABLE_SPECTRA_FIELD_CLUSTER;
  this.colTypes.push(auxS);
  ...
  var auxS = new ReportColumnTypeString();
  auxS.columnLabel   = REPORT_HEADER_SPECTRA_13;
...
renderer.prototype.buildTable = function(out, tab, start, ipp, functionName)
{
  ...
  if(ipp != -1 && tab.getSize() > PAGE_LENGTH)
    this.paginate(paginationSequenceBefore, paginationSequenceAfter, tab, functionName, start, ipp);
  ...
  if(tab.getSize() == 0) {
    ...
    addToReference(out, "<table>");
    addToReference(out, "<tr><td><p>No items to display.</p></td></tr>");
    addToReference(out, "</table>");
    return;
  }
...
renderer.prototype.getTag = function(tag, row, tagOpen, tagClose, add)
{
  ...
  var auxM = tag.split(TAG_CONDITIONAL_IF);
  // check if we have conditional tags. If so, use the form a = b ? c : d
  if(auxM.length == 2) {
    // split the condition by the equal sign
    var ab = auxM[0].split(TAG_CONDITIONAL_EQ);
    // split the option by the : sign
    var cd = auxM[1].split(TAG_CONDITIONAL_ELSE);
    // check if we have what we need
    if(ab.length == 2 && cd.length == 2) {
      var a = this.translateTag(ab[0], row, add, true) ;
      var b = this.translateTag(ab[1], row, add, true);
      var c = this.translateTag(cd[0], row, add, true);
      var d = this.translateTag(cd[1], row, add, true);
  ...
  var aux = tag.split(TAG_CONDITIONAL_OR);

  for(var i = 0 ; i < aux.length ; i++) {
    // translate the tag contents
    var content = this.translateTag(aux[i], row, add, false);
...
///////////////////////////////////////////////////////////////////////////////
renderer.prototype.translateTag = function(tag, row, add, preserveEmpty)
{
  // set default return value
  var ret = (preserveEmpty == true ? tag : "");
  ...
  else if(tag == INTERNAL_AAS_FNAME)
    ret = AAS_FILE;
...
////////////////////////////////////////////////////////////////////////////////
renderer.prototype.paginate = function(out, out2, tab, functionName, start, ipp)
{
  if(typeof(start) == 'undefined')
    start = 0;
  ...
  while(pos >= 0) {
    ...
    var endIndex = k + ipp - 1;
    var j = tab.peek(endIndex);
    var id2 = tab.getSingleId(j);

    //alert("k = " + k + " -> " + pos + "\nend = " + endIndex + " -> " + j);

    //alert("tab.sortColumn = " + tab.sortColumn  + "\ntab.paginationColumns = " + tab.paginationColumns);

    var aux4 = "[";

    if(tab.paginationColumns.contains(tab.sortColumn)) {
      aux4 += id1;
      if(j > pos)
        aux4 += "&nbsp;-&nbsp;" + id2;
     } else {
...
renderer.prototype.renderTableExceptionProteinHeader = function(out, tab)
{
  ...
  var proteinDesc  = row[TABLE_PROTEINS_FIELD_DESC];
