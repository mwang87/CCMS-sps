...
namespace specnets
{
    ...
    class SpectralLibrary : public SpecSet
    {
        public:
            ...
            virtual int search(Spectrum &query_spec, PeptideSpectrumMatchSet &output_psms, float parentmass_tolerance, float ion_tolerance, int top_hits, int analog_search = 0, float score_threshold = 0.0, int library_search_quality = 1000);
