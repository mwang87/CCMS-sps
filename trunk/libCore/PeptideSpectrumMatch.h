...
namespace specnets
{
  ...
  public:
     ...
     * @return = returns false when modification is unable to be parsed
     */
    bool getModificationsAndPositions(vector<float> &modifications, vector<
     ...
     */
    bool insertModifications(const vector<float> &modifications, const vector<
        unsigned int> &positions, string &outputPeptide) const;
    /**
     * Inserts modifications into peptide
     *
